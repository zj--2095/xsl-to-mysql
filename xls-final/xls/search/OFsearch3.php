...
if($_POST&&$er=='yes')
{
	...
	/*查询数据库*/
	$sql = "Select * from contact left join departmental ON departmental.departmental=contact.departmental inner join service on contact.contact=service.contact ";
	$sql.="where"; 
	#if($contact!=="")
	$sql.=" contact.contact like '%$contact%'";
    #if($phone!=="")
	$sql.=" and contact.phone like '%$phone%'";
    #if($departmental!=="")
	$sql.=" and contact.departmental like '%$departmental%'";
    #if($email!=="")
	$sql.=" and contact.email like '%$email%'";
